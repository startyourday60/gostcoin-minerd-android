...
/cygdrive/c/Users/oruge/AppData/Local/Android/Sdk//ndk/25.1.8937393/toolchains/llvm/prebuilt/windows-x86_64/bin/aarch64-linux-android21-clang  -Icurl-android-ios-master/prebuilt-with-ssl/android/include  -L/. -o minerd minerd-cpu-miner.o minerd-util.o minerd-sha2.o minerd-sha2-arm.o minerd-sha2-x86.o minerd-sha2-x64.o minerd-scrypt.o minerd-scrypt-arm.o minerd-scrypt-x86.o minerd-scrypt-x64.o minerd-blake.o minerd-bmw.o minerd-groestl.o minerd-jh.o minerd-keccak.o minerd-skein.o minerd-aes_helper.o minerd-cubehash.o minerd-shavite.o minerd-simd.o minerd-echo.o minerd-luffa.o minerd-quark.o minerd-gost.o minerd-Xcoin.o compat/jansson/libjansson.a libcurl.a